...
date: 2024-06-26
slug: "deploy-container-from-the-ghcr-private-registry-to-ecs"
tags:
  - "React"
  - "GitHub"
  - "Actions"
...
### Контейнер в ghcr.io {#container-in-ghcrio}
...
![GitHub Container Registry](ghcr-to-ecs-container.png)
...
![GitHub Profile Settings](ghcr-to-ecs-profile-settings.png)

Внизу сторінки оберіть **Developer settings**

![GitHub Developer Settings](ghcr-to-ecs-profile-dev-settings.png)

Далі, виберіть **Personal access tokens**/**Tokens (classic)**/**Generate new token (classic)**.

![GitHub Personal Access Tokens](ghcr-to-ecs-profile-token-classic.png)
...
![GitHub New Personal Access Token](ghcr-to-ecs-profile-new-token.png)
...
![GitHub Personal Access Token](ghcr-to-ecs-profile-created-token.png)
...
## Створення CMK в AWS KMS {#creating-a-cmk-in-aws-kms}
...
![AWS CloudShell](ghcr-to-ecs-cloudshel.png)
...
![AWS KMS Create Key](ghcr-to-ecs-kms-create-key.png)

ARN CMK вам знадобиться при створенні документа політики довіри на наступному кроці.

## Створення Secret в AWS Secrets Manager {#creating-a-secret-in-aws-secrets-manager}
...
## Створення ролі в IAM для виконання завдання {#creating-an-iam-role-for-task-execution}
...
## Налаштування ECS CLI (необовʼязково) {#configuring-ecs-cli-optional}
...
## Створення кластера Amazon ECS {#creating-an-amazon-ecs-cluster}
...
## Налаштування групи безпеки {#configuring-security-group}
...
## Створення Service Amazon ECS {#creating-an-amazon-ecs-service}
