...
## Створення застосунку React {#create-a-react-app}
...
![Create React App 1](npx-boilerplating-1.png)
![Create React App 2](npx-boilerplating-2.png)

## Створення репозиторію на GitHub {#create-a-github-repository}
...
![Create GitHub Repository](gh-repo-create.png)

## Налаштування репозиторію {#adjust-repository-settings}

Перейдіть до налаштувань репозиторію та увімкніть GitHub Pages. Оберіть джерело для **Build and deployment** — GitHub Actions.

![GitHub Pages Settings](gh-repo-pages-source.png)
...
![GitHub Actions Permissions](gh-repo-actions.png)

## Додавання робочого процесу GitHub Actions {#add-github-actions-workflow}
...
## Налаштування `package.json` {#adjust-packagejson}
...
## Розгортання застосунку React {#deploy-the-react-app}
...
![Deployed React App](deployed-react-app.png)
