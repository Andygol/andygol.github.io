...
## YAML – для збереження даних {#yaml-is-for-saving-data}
...
## Git-репозиторій як сховище даних {#git-repository-as-a-data-store}
...
## Набір змін OSM — коміт git {#osm-changeset-git-commit}
...
## Переваги використання git {#advantages-of-using-git}
...
### Підсумок можливостей API OSM з використанням git {#summary-of-osm-api-capabilities-using-git}
...
## Розподіл великих обʼєктів між тайлами {#distribution-of-large-objects-between-tiles}
