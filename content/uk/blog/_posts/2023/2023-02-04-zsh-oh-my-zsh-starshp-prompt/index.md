...
date: 2023-02-04
slug: "zsh-oh-my-zsh-starshp-prompt"
tags:
  - "macOS"
  - "zsh"
  - "starship"
...
## Встановлення / оновлення Zsh {#installing-updating-zsh}
...
> Див. [Оновлюємо версію zsh у Ventura 13.2 на MacBook pro](/uk/blog/2023/02/03/m1-ventura-zsh/)
...
![розташування zsh](zsh-check.png)
...
## Встановлюємо Oh My Zsh {#installing-oh-my-zsh}
...
![omz-white](omz-white.png)

### Налаштування **`~/.zshrc`** {#tuning-of-the-zshrc}
...
![install brew zsh-completion](brew-zsh-completion.png)
...
![zsh-completion permissions](zsh-completion-permissions.png)
...
![~/.zshrc completion section](zshrc-completion.png)
...
![brew search completion](brew-search-completion.png)
...
### Підсвічування синтаксису {#syntax-highlighting}
...
![Hack Regular Nerd Font](hack-regular-nerd-font.png)
...
![командний рядок в терміналі](terminal-spaceship-prompt.png)

## Власний профіль термінала {#custom-terminal-profile}
...
![terminal ToyChest](terminal-toychest.png)
